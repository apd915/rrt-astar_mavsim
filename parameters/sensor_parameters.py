...
#-------- Rate Gyro --------
gyro_x_bias = 0.01 #np.radians(5*np.random.uniform(-1, 1))  # bias on x_gyro
gyro_y_bias = -0.01 #np.radians(5*np.random.uniform(-1, 1))  # bias on y_gyro
gyro_z_bias = 0.02 #np.radians(5*np.random.uniform(-1, 1))  # bias on z_gyro
